...
public class Tileset {
    public static final TETile AVATAR = new TETile('@', Color.white, Color.black, "You", "Link_zelda.png", 0); //need to pixel it to 16x16
    ...
    public static final TETile GRASS = new TETile('"', Color.green, new Color(116, 180, 116), "Grass", 4);
    ...
    public static final TETile HEART = new TETile('♥', Color.RED, Color.black, "FULL_HEART",13); //"src/core/full_heart_16x16.png" ,
    public static final TETile EMPTY_HEART = new TETile('♡', Color.RED, Color.black, "FULL_HEART",14); //"src/core/empty_heart_16x16.png" ,
